...
DefaultUiData:
    ...
    .dw deft($EE,1) | T_HIGHP
    .dw deft($EF,1) | T_HIGHP
    ...
    .dw 0
    .dw deft($12,6) | T_HIGHP
    .dw deft($FE,1) | T_HIGHP
    .dw deft($FF,1) | T_HIGHP
    .dw deft($12,6) | T_HIGHP | T_FLIPH
...
PaletteAllocToSpriteSwizzleDef:
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALLETE_ALLOC_NONE 0
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALLETE_ALLOC_8A  %00000001
    .dw PALETTE_SWIZZLE_B_AB << 14 ; PALLETE_ALLOC_8B  %00000010
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALLETE_ALLOC_12A %00000011
    .dw PALETTE_SWIZZLE_A_A  << 14 ; PALLETE_ALLOC_8C  %00000100
    .dw PALETTE_SWIZZLE_AB_A << 14 ; PALLETE_ALLOC_12C %00000101
    .dw PALETTE_SWIZZLE_B_AB << 14 ; PALLETE_ALLOC_12B %00000110
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALLETE_ALLOC_16  %00000111
