...
.SoftSetBank $7E
.IgnoreDirect
.procimpll "MapGen.UpdateDoorsForDevilRoom"
    ; west door
...
.SoftSetBank $7E
.IgnoreDirect
.procdefines "_CountAdjacentFilledRoomsA"
    sta.b $02
    stz.b $03
...
.SoftSetBank $7E
.IgnoreDirect
.procdefines "_CalculateAvailableEndpointTiles"
...
@loop:
    ...
    .call "_CountAdjacentFilledRoomsA"
    ldy $03
...
.SoftSetBank $7E
.IgnoreDirect
.procdefines "_CalculateAvailableStartingRoomEndpointTiles"
    lda.b start_pos
    sta.b $02
    stz.b mapgenNumAvailableEndpointTiles
    lda.b mapgenNumAvailableTiles
...
.SoftSetBank $7E
.IgnoreDirect
.procdefines "_MoveActiveRoomsIntoUsedTiles"
    ; stz.b mapgenNumAvailableEndpointTiles
...
.SoftSetBank $7E
.IgnoreDirect
.procdefines "_FindValidSecretRoomLocations"
    lda #0
...
@retry:
    ...
    lda #ROOMTYPE_START
    pha
    .call "MapGen.InitializeRoomX"
    pla
    lda.b start_pos
    .call "_PushAdjacentEmptyTilesA"
    .ForceSetAX 16, 16
...
@loop_add_tiles: ; do {
    phy
        ...
        bcc @add_adjacent_to_start
            .call "_CalculateNewEndpointTiles"
            lda.b mapgenNumAvailableEndpointTiles
            bne +
                .call "_CalculateAvailableEndpointTiles"
            +:
...
; setup special rooms
    ; Determine endpoint tiles
    .call "_MoveActiveRoomsIntoUsedTiles"
    .ForceSetAX 16, 16
    ldx #mapgenUsedTiles
    ...
    ; SUPER SECRET
        ...
        sta.w loword(roomSlotRoomType),Y
; add secret room
    .call "_FindValidSecretRoomLocations"
    .ForceSetAX 16, 16
    ldx #mapgenUsedTiles
    lda.w mapgenNumUsedTiles
    and #$00FF
