...
PaletteAllocToSpriteSwizzleDef:
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALETTE_ALLOC_NONE 0
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALETTE_ALLOC_8A  %00000001
    .dw PALETTE_SWIZZLE_B_AB << 14 ; PALETTE_ALLOC_8B  %00000010
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALETTE_ALLOC_12A %00000011
    .dw PALETTE_SWIZZLE_A_A  << 14 ; PALETTE_ALLOC_8C  %00000100
    .dw PALETTE_SWIZZLE_AB_A << 14 ; PALETTE_ALLOC_12C %00000101
    .dw PALETTE_SWIZZLE_B_AB << 14 ; PALETTE_ALLOC_12B %00000110
    .dw PALETTE_SWIZZLE_NONE << 14 ; PALETTE_ALLOC_16  %00000111
